<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li style="font-size: 16px; font-weight: bold"><a href="{{route('suggested_service.show_suggested_services')}}"><i class="fa fa-list" aria-hidden="true"></i><span>@lang('site.suggested_services')</span></a></li>
            ...
            <li style="font-size: 16px; font-weight: bold"><a href="{{route('order.index', 'order_status=canceled')}}"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>@lang('site.canceled_orders')</span></a></li>
            ...
            <li class="treeview" style="font-size: 16px; font-weight: bold">
                <a href="#">
                    <i class="fa fa-bullhorn"></i><span>@lang('site.ads')</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu" style="font-size: 13px; font-weight: bold">
                    <li style="font-size: 16px; font-weight: bold"><a href="{{route('ad.index')}}"><i class="fa fa-circle-o" aria-hidden="true"></i><span>@lang('site.ads')</span></a></li>
