        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h1 class="box-title" style="color: red; font-size: 20px; font-weight: bold"> <?php echo __('site.edit')?> @lang('site_setting.diameter_search')</h1>
                        ...
                        <div class="row mb-3 margin-bottom">
                            @foreach($langs as $lang)
                                <div class="col-md-6 pr-md-1">
                                    ...
                                    <input style="font-weight: bold; font-size: 14px;" type="text" name="diameter_search[setting_name][{{$lang['lang_symbol']}}]" class="form-control" value="{{$diameter_search['setting_name'][$lang['lang_symbol']]}}">
                                </div>
                            @endforeach
                        </div>
