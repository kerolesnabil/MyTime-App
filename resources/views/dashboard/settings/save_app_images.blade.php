        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h1 class="box-title" style="color: #605ca8; font-size: 20px; font-weight: bold"> <?php echo __('site.edit')?> @lang('site_setting.app_images')</h1>
                    ...
                    <form class="form-group" action="{{ route('setting.save_app_images') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 margin-bottom">
                            @foreach($langs as $lang)
                                <div class="col-md-6 pr-md-1">
                                    ...
                                    <input style="font-weight: bold; font-size: 14px;" type="text" name="user_splash[setting_name][{{$lang['lang_symbol']}}]" class="form-control" value="{{$user_splash['setting_name'][$lang['lang_symbol']]}}" readonly>
                                </div>
                            @endforeach
                        </div>
                        <div class="row mb-3 margin-bottom">
                        ...
                        <div class="row mb-3 margin-bottom">
                            @foreach($langs as $lang)
                                <div class="col-md-6 pr-md-1">
                                    <label style="color: #007cff; font-size: 18px">{{$lang['lang_symbol']}}</label>
                                    <input style="font-weight: bold; font-size: 14px;" type="text" name="user_logo[setting_name][{{$lang['lang_symbol']}}]" class="form-control" value="{{$user_logo['setting_name'][$lang['lang_symbol']]}}" readonly>
                                </div>
                            @endforeach
                        </div>
                        <div class="row mb-3 margin-bottom">
                        ...
                        <div class="row mb-3 margin-bottom">
                            @foreach($langs as $lang)
                                <div class="col-md-6 pr-md-1">
                                    <label style="color: #007cff; font-size: 18px">{{$lang['lang_symbol']}}</label>
                                    <input style="font-weight: bold; font-size: 14px;" type="text" name="vendor_splash[setting_name][{{$lang['lang_symbol']}}]" class="form-control" value="{{$vendor_splash['setting_name'][$lang['lang_symbol']]}}" readonly>
                                </div>
                            @endforeach
                        </div>
                        <div class="row mb-3 margin-bottom">
                        ...
                        <div class="row mb-3 margin-bottom">
                            @foreach($langs as $lang)
                                <div class="col-md-6 pr-md-1">
                                    <label style="color: #007cff; font-size: 18px">{{$lang['lang_symbol']}}</label>
                                    <input style="font-weight: bold; font-size: 14px;" type="text" name="vendor_logo[setting_name][{{$lang['lang_symbol']}}]" class="form-control" value="{{$vendor_logo['setting_name'][$lang['lang_symbol']]}}" readonly>
                                </div>
                            @endforeach
                        </div>
                        <div class="row mb-3 margin-bottom">
