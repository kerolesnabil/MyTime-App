...
class SaveAdminRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'user_user_date_of_birth.required' => __('site_admin.rule_user_user_date_of_birth.required'),
            'user_user_date_of_birth.date'     => __('site_admin.rule_user_user_date_of_birth.date'),
